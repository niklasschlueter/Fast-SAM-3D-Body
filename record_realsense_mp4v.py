#!/usr/bin/env python3
# Same as record_realsense.py but uses mp4v instead of avc1 (h264_v4l2m2m),
# which works on systems without a V4L2 M2M hardware encoder (e.g. NVIDIA workstations).
import argparse
import json
